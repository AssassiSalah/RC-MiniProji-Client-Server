...
public class UIController {
	...
	private void connect() {
    	...
    	fileManager = new FileManager(connectionManager.getInputStream(), connectionManager.getOutputStream(), logArea, progressBar);
	}	
    ...
    private void importFile() {
		String filePath = FileManager.importFile();
