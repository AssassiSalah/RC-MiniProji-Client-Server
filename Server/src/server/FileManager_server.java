...
public class FileManager_server {
    ...
    public FileManager_server(DataInputStream dataInputStream, DataOutputStream dataOutputStream) {
	...
	public boolean processRequest(String command, File dir, String requestedFileName) throws IOException, NoSuchAlgorithmException {
